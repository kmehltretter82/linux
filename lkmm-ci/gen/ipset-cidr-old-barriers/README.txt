...
RUNNING ONE TEST
  Tests are .exe files, for instance ipset-cidr-old-barriers.exe, run it by './ipset-cidr-old-barriers.exe'
...
RUNNING OPTIONS
  ...
  For more options see for instance './ipset-cidr-old-barriers.exe -help' and litmus documentation
